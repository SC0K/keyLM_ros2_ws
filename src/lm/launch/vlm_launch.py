...
def generate_launch_description() -> LaunchDescription:
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("camera_robot_xml", default_value=PythonExpression([
                repr(os.path.join(get_package_share_directory("crl_humanoid_commons"), "data", "robots", "g1_description", "scene_crl_with_bucket.xml")),
                " if '", LaunchConfiguration("scene_object"), "' == 'bucket' else ''"])),
            DeclareLaunchArgument("camera_object_joint_name", default_value=PythonExpression([
                "'bucket_freejoint' if '", LaunchConfiguration("scene_object"), "' == 'bucket' else 'box_freejoint'"])),
            ...
            DeclareLaunchArgument("retarget_object_type", default_value="box", choices=["box", "bucket"],
                                  description="Fallback for legacy unsuffixed requests; named _box/_bucket keyframes choose retargeting automatically."),
            ...
            DeclareLaunchArgument("tracked_box_pose_topic", default_value="/mocap/box_pose"),
            DeclareLaunchArgument("tracked_bucket_pose_topic", default_value="/mocap/bucket_pose"),
            DeclareLaunchArgument("tracked_object_timeout_sec", default_value="1.0"),
                        ...
                        parameters=[
                            {
                                ...
                                "mocap_object_selection": ParameterValue(LaunchConfiguration("mocap_object_selection"), value_type=bool),
                                ...
                                "tracked_object_timeout_sec": ParameterValue(LaunchConfiguration("tracked_object_timeout_sec"), value_type=float),
